...
const submit = ()=>{
    form.post(route('admin.voice-file.store'));
}
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="d-flex justify-content-between align-items-center border-bottom" >
                            <h5 class="card-header">Create File List</h5>
                            <div class="me-5">
                        ...
                        <div class="card-body">
                            <form @submit.prevent="submit" method="post">
                                <div class="row">
                                    ...
                                    <div class="mb-4 col-md-6">
                                        <label class="form-label" for="file">Voice File <i class="text-danger">*</i></label>
                                        <input type="file" class="form-control" ref="fileInput" accept=".mp3,.wav" @change="handleFileUpload" :class="{'is-invalid' : form.errors.file}" id="file" >
