                                ...
                                <div class="card-body">
                                    ...
                                    <div class="app-brand justify-content-center mb-6">
                                        ...
                                        <span class="app-brand-logo demo">
                                            ...
                                            <span class="app-brand-text demo text-heading fw-bold">Phone Verification</span>
                                        </a>
                                    </div>

                                    <h5 class="text-center">We've send a verification code to {{ phone }} </h5>
