...
<template>
    ...
    <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
        ...
        <ul class="menu-inner py-1">
            ...
            <li class="menu-item " :class="$page.url.startsWith('/admin/number-list') || $page.url.startsWith('/admin/voice-file') || $page.url.startsWith('/admin/campaigns') ? 'open active' : ''">
                <a href="javascript:void(0)" class="menu-link menu-toggle">
                    <i class="menu-icon tf-icons bx bx-copy"></i>
                    <div class="text-truncate" data-i18n="Extended UI">Camping</div>
                </a>
                <ul class="menu-sub">
                    <li class="menu-item " :class="$page.url.startsWith('/admin/number-list') ? 'active' : ''">
                        <Link :href="route('admin.number-list.index')" class="menu-link">
                            <div class="text-truncate" data-i18n="Perfect Scrollbar">Number List</div>
                        </Link>
                    </li>

                    <li class="menu-item " :class="$page.url.startsWith('/admin/voice-file') ? 'active' : ''">
                        <Link :href="route('admin.voice-file.index')" class="menu-link">
                            <div class="text-truncate" data-i18n="Perfect Scrollbar">Voice File</div>
                        </Link>
                    </li>

                    <li class="menu-item " :class="$page.url.startsWith('/admin/campaigns') ? 'active' : ''">
                        <Link :href="route('admin.campaigns.index')" class="menu-link">
                            <div class="text-truncate" data-i18n="Perfect Scrollbar">Campaign</div>
                        </Link>
                    </li>
